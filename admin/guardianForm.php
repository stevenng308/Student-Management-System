...
?>
	...
	<form name ="register" id="register-form" class="form-signin" action="#" method="post">
		...
		<br />
		<div class="control-group">
			<textarea class="form-control" rows="4" cols="11" name="childrenID" id="childrenID" placeholder="Enter The Child's Student ID Number. If there are more than one, separate them with a comma (1234,5678). Max length for a Student ID is 10."></textarea>
		</div>
		<br />
