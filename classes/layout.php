			...
			<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="index.php">School Wide Communications Hub</a>
				</div>
			...
			<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="'. $dir .'index.php">School Wide Communications Hub</a>
				</div>
				<div class="collapse navbar-collapse">
				  <ul class="nav navbar-nav">
					' . $links . '
					...
					<div class="modal fade" id="myModal' . $modalNum . '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					  <div class="modal-dialog">
						<div class="modal-content">
						  ...
						  <div class="modal-footer">
							<button class="btn btn-danger pull-left" data-dismiss="modal" onclick="deleteReadEmail(\'' . $box . '\', ' . $mail->getID() . ')">Delete</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
